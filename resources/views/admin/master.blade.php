...
<head>
    ...
    <title>Dashboard -Admin Manage</title>
                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="{{route('company.manage')}}">Show All Company</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{route('employee.add')}}">Add Employee</a>
                            <a class="nav-link" href="{{route('employee.manage')}}">Show All Employee</a>
                        </nav>
                    </div>
